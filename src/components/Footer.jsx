              ...
              <div className="col-lg-3 col-md-5">
                <div className="footer-widget">
                  ...
                  <div className="footer-contact-wrap">
                    ...
                    <ul className="list-wrap">
                      <li className="phone"><i className="fa fa-phone"></i> +1 31-6555-0116</li>
                      <li className="mail"><i className="fa fa-envelope"></i> Ecommerce@example.com</li>
                      <li className="website"><i className="fa fa-globe"></i> www.Ecommercedomain.com</li>
                    </ul>
                  </div>
                </div>
              </div>
          ...
          <div className="row align-items-center">
            <div className="col-md-7">
              <div className="copyright-text">
                <p>Copyright © 2026 Ecommerce All Rights Reserved.</p>
              </div>
            </div>
